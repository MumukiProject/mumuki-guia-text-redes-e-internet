...
¡Fácil! Con un método llamado **IP** (_Internet Protocol_), en el que cada nodo recibe un número de identificación, conocido como _dirección IP_, que es un único dentro de la red. Así, los datos que viajan saben cuál es su _nodo destino_. 
